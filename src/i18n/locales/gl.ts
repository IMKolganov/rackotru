...
export const gl: Partial<Translations> = {
    meta: {
    ...
    about: {
      ...
      lead: 'Desenvolvedor en {{location}}, en {{company}}. Enfócame en produtos de rede seguros — de clientes VPN a infraestrutura en contedores.',
      highlights: [
    ...
    footer: {
      builtWith: 'Feito con React e Vite',
