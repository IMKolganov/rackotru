...
export const is: Partial<Translations> = {
    meta: {
    ...
    about: {
      ...
      lead: 'Þróunarmaður í {{location}}, hjá {{company}}. Einbeiti mér að öruggum netvörum — frá VPN biðlurum til geymsluvæddra innviða.',
      highlights: [
    ...
    footer: {
      builtWith: 'Byggt með React og Vite',
