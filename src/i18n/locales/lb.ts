...
export const lb: Partial<Translations> = {
    meta: {
    ...
    about: {
      eyebrow: 'Iwwer mech',
      title: 'Wat ech bauen',
      lead: 'Entwéckler zu {{location}}, bei {{company}}. Fokus op sécher Netzwierkprodukter — vu VPN-Clienten bis containeriséierter Infrastruktur.',
      highlights: [
    ...
    footer: {
      builtWith: 'Gebaut mat React & Vite',
