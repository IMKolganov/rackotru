...
export const lt: Partial<Translations> = {
    meta: {
    ...
    about: {
      eyebrow: 'Apie',
      title: 'Ką kuriu',
      lead: 'Kūrėjas iš {{location}}, {{company}}. Fokusuojuosi į saugius tinklo produktus — nuo VPN klientų iki konteinerizuotos infrastruktūros.',
      highlights: [
    ...
    footer: {
      builtWith: 'Sukurta su React ir Vite',
