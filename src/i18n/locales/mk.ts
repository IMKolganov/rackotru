...
export const mk: Partial<Translations> = {
    meta: {
    ...
    about: {
      eyebrow: 'За мене',
      title: 'Што градам',
      lead: 'Развој во {{location}}, во {{company}}. Фокус на безбедни мрежни производи — од VPN клиенти до контејнеризирана инфраструктура.',
      highlights: [
    ...
    footer: {
      builtWith: 'Направено со React и Vite',
