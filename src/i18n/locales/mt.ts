...
export const mt: Partial<Translations> = {
    meta: {
    ...
    about: {
      eyebrow: 'Dwar',
      title: 'X\'nbeni',
      lead: 'Żviluppatur f\'{{location}}, f\'{{company}}. Fokus fuq prodotti tan-netwerk siguri — minn klijenti VPN għal infrastruttura konteniturizzata.',
      highlights: [
    ...
    footer: {
      builtWith: 'Magħmul b\'React u Vite',
