...
export const no: Partial<Translations> = {
    ...
    about: {
      ...
      lead: 'Utvikler i {{location}}, hos {{company}}. Fokus på sikre nettverksprodukter — fra VPN-klienter til containerisert infrastruktur.',
      highlights: [
    ...
    footer: {
      builtWith: 'Bygget med React og Vite',
