...
export const sk: Partial<Translations> = {
    meta: {
    ...
    about: {
      eyebrow: 'O mne',
      title: 'Čo tvorím',
      lead: 'Vývojár z {{location}}, v {{company}}. Zameriavam sa na bezpečné sieťové produkty — od VPN klientov po kontajnerizovanú infraštruktúru.',
      highlights: [
    ...
    footer: {
      builtWith: 'Vytvorené v React a Vite',
