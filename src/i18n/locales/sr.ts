...
export const sr: Partial<Translations> = {
    ...
    about: {
      eyebrow: 'О мени',
      title: 'Шта градим',
      lead: 'Развој у {{location}}, у {{company}}. Фокус на сигурне мрежне производе — од VPN клијената до контејнеризоване инфраструктуре.',
      highlights: [
    ...
    footer: {
      builtWith: 'Направљено са React и Vite',
